          ...
          <table class="table table-bordered">
                  ...
                  <?php $no=1; ?> 
                    ...
                    <tr>
                      ...
                      <td><?= $row['Qty'];?></td>
                      <td>
                        <a href="<?= base_url; ?>/barang/edit/<?= $row['Id_Barang'] ?>" class="badge badge-info ">Edit</a> <a href="<?= base_url; ?>/barang/hapus/<?= $row['Id_Barang'] ?>" class="badge badge-danger" onclick="return confirm('Hapus data?');">Hapus</a>
                      </td>
                    </tr>
                    <?php $no++; endforeach; ?>
                  </tbody>
